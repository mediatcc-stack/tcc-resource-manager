...
| `recipient:<id>` | สถานะการรับแจ้งเตือนของกลุ่มนั้น (1 key ต่อ 1 กลุ่ม, v2.3 ขึ้นไป)<br>`1` / `on` = รับ · `off` = ปิดเอง · `left:<เวลา>` = บอทไม่ได้อยู่ในกลุ่มแล้ว<br>บอทออกจากกลุ่มจะ**ไม่ลบ key** เพื่อให้ Group ID ยังอยู่ให้ก็อปไปใช้ต่อ |
