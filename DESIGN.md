...
*   **ปัดสลับแท็บ (มือถือ):** ปัดซ้าย/ขวาบนเนื้อหาของระบบเพื่อสลับแท็บถัดไป/ก่อนหน้า (ไม่วนกลับเมื่อสุดปลายทาง)
    เนื้อหาเลื่อนเข้าตามทิศทางที่ปัดด้วย `animate-swipe-from-right` / `animate-swipe-from-left`
    และมีคำใบ้ใต้แถบแท็บบนจอเล็ก ซึ่งจะซ่อนถาวรหลังผู้ใช้ปัดสำเร็จครั้งแรก
